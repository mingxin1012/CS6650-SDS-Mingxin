...
public class LiftRideThread extends Thread{
    ...
    private final CountDownLatch overallLatch;
    ...
    public LiftRideThread(BlockingQueue<LiftRideEvent> inputQueue, SkiersApi apiInstance, CountDownLatch latch, CountDownLatch overallLatch, RequestCounter numPassedRequests, RequestCounter numFailedRequests) {
